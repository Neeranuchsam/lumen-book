...
class BundlesControllerTest extends TestCase
{
    ...
    public function test_show_should_return_a_valid_bundle()
    {
        ...
        $this->get("/bundles/{$bundle->id}", $this->header_request_accept_type);
        ...
        $this->assertEquals($bundle->books[0]->title, $books['data'][0]['title']);
        $this->assertEquals($bundle->books[0]->description, $books['data'][0]['description']);
        $this->assertEquals($bundle->books[0]->author->name, $books['data'][0]['author']);
        $this->assertEquals($bundle->books[0]->created_at->toIso8601String(), $books['data'][0]['created']);
        $this->assertEquals($bundle->books[0]->updated_at->toIso8601String(), $books['data'][0]['updated']);
    }
    ...
    public function test_addBook_should_add_a_book_to_a_bundle()
    {
        ...
        $this->put("/bundles/{$bundle->id}/books/{$book->id}", [], $this->header_request_accept_type);
